...
var _yargs$demand$option$option = _yargs2['default'].demand(1).option('script', {
  'default': 'test-main',
...
var argv = _yargs$demand$option$option.argv;
...
new _.Runner(peer, range, { script: script, bail: bail }).on('versions', function (versions) {
